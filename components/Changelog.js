    ...
    h('div', { class: 'changelog-section' },
      ...
      h('div', { class: 'changelog-entry' },
        ...
        h('div', { class: 'changelog-version-entry' },
          h('h5', null, 'Version 1.8.1 - New Recruit Tournament Rename'),
          h('p', null, 'Renamed the internal "NR_WTC_COMPACT" format to "NR_TOURNAMENT", matching New Recruit\'s current name for this export style. Removed the standalone "NR_WTC" format entirely, since New Recruit no longer produces it.')),
        h('div', { class: 'changelog-version-entry' },
          h('h5', null, 'Version 1.8.0 - New Recruit Attached Units Support'),
